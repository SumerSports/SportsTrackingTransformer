...
|--------|------------------|-------------|-------------|
| **Test Set ADE** | 5.71 yards | **4.57 yards** | **20.0%** (1.14 yards) |
| **At Tackle Frame** | 4.03 yards | **1.02 yards** | **74.7%** (3.01 yards) |
| **Near Contact (0-5 frames)** | 4.12 yards | **1.26 yards** | **69.4%** (2.86 yards) |
...
- **Zoo Architecture** peaks at 73K parameters (5.71 yards), then **degrades** with more capacity → 5.93 yards at 5.9M params
- **Transformer Architecture** improves with scaling: 4.90 → 4.64 → 4.57 yards
- **Even small Transformers win**: A 52K-parameter Transformer (4.90 yards) handily beats the best 72K-parameter Zoo (5.71 yards) - **14% better with fewer parameters**
